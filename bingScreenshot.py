...
async def main():
    ...
    try:
        ...
        screenshot_filename = f'{social_denomination}.jpg'
        screenshot_path = os.path.join(current_working_directory, 'public', 'screenshotWebs', screenshot_filename)
        ...
        await page.screenshot({'path': screenshot_path, 'type': 'jpeg', 'fullPage': True})
...
if __name__ == '__main__':
    asyncio.run(main())
    print("La captura de pantalla fue realizada con éxito y se encuentra en la carpeta screenshotWebs")
